...
threeway_interaction_analysis = outlier_detection(threeway_interaction_analysis, trial_sd_cut = 2, participant_sd_cut = 9, participant_id, is_congruent, n_min3_cong, n_min4_valence)
...
```{r}
(1 - (nrow(response_rt_analysis)/nrow(unfiltered_test)))*100
```
...
write_tsv(cohen_effect_analysis, file.path(current_version,"data","Processed", "cohen_effect_processed.tsv"))
write_tsv(threeway_interaction_analysis, file.path(current_version,"data","Processed", "threeway_interaction_processed.tsv"))
