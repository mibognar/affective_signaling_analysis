...
cse_plot_rt <- 
  ...
  scale_y_continuous(limits = c(750, 950)) +
...
```{r}
ggsave(file.path(current_version, "ppc_rt_cse.png"), width = 14.4, height = 8, plot = last_plot())
```
