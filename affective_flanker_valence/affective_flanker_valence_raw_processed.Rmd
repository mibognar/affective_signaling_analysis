...
write_tsv(cohen_effect_analysis, file.path(current_version, "data", "Processed", "flanker_valence_cohen_effect.tsv"))


write_tsv(threeway_interaction_analysis, file.path(current_version, "data", "Processed", "flanker_valence_threeway_interaction.tsv"))
