...
congruency_effect_model <- lmer(rt ~ is_prev_congruent + is_congruent + (1|filename), data = processed_rt)
...
Bf(sd = congruency_effect_model_summary$coefficients[6],
   obtained = congruency_effect_model_summary$coefficients[3]*-1,
   dfdata = congruency_effect_model_summary$coefficients[9],
   meanoftheory = 0,
   sdtheory = 60,
   dftheory = 10^10,
   tail = 1)
