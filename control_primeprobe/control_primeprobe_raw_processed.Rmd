...
```{r calculate accuracy}
test %>%
  group_by(participant_id, drop_participant_acc) %>%
  count() %>%
  group_by(drop_participant_acc) %>%
  count()
```
...
```{r}
test %>%
  group_by(participant_id, drop_participant_rt) %>%
  count() %>%
  group_by(drop_participant_rt) %>%
  count()

```

# all participant exclusion counts
```{r}
test %>%
  group_by(participant_id, drop_participant_rt, drop_participant_acc) %>%
  count() %>%
  group_by(drop_participant_rt, drop_participant_acc) %>%
  count()
```
