...
#Check how many participants were dropped

```{r}
raw %>% distinct(participant_id) %>% count()
...
write_tsv(response_rt_nmin3_analysis, file.path(current_version,"data","Processed", "aspp_arousal_rt_processed_nmin3.tsv"))

write_tsv(response_acc_analysis, file.path(current_version,"data","Processed", "aspp_arousal_acc_processed.tsv"))
```
