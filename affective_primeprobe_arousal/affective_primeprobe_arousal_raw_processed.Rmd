...
source("../outlier_detection_acc.R")
```
...
sequential_cse = outlier_detection(unfiltered_test, trial_sd_cut = 2.5, participant_sd_cut = 9, participant_id, is_congruent, n_min3_cong)

threeway_interaction_analysis = unfiltered_test %>% 
  filter(!is.na(n_min4_arousal))
threeway_interaction_analysis = outlier_detection(threeway_interaction_analysis, trial_sd_cut = 2, participant_sd_cut = 9, participant_id, is_congruent, n_min3_cong, n_min4_arousal)

threeway_between_analysis = outlier_detection(unfiltered_test, trial_sd_cut = 2, participant_sd_cut = 9, participant_id, is_congruent, n_min3_cong, is_prev_cong)

accuracy_analysis = outlier_detection_acc(unfiltered_test,trial_sd_cut = 2.5, participant_sd_cut = 2.5, participant_id, is_congruent, is_prev_cong)
...
sequential_cse = global_exclusion(sequential_cse, T)
threeway_between_analysis = global_exclusion(threeway_between_analysis, T)

response_acc_analysis = global_exclusion_acc(accuracy_analysis, F)
```
...
write_tsv(sequential_cse, file.path(current_version,"data","Processed", "sequential_cse_processed.tsv"))

write_tsv(threeway_between_analysis, file.path(current_version,"data","Processed", "threeway_between_processed.tsv"))

write_tsv(response_acc_analysis, file.path(current_version,"data","Processed", "response_acc_processed.tsv"))
```
