...
```{r}
noga_cohen_effect_model = lmer(rt ~ is_congruent * is_prev_cong * n_min3_cong + (1|filename), data = processed_rt)
summary(noga_cohen_effect_model)
