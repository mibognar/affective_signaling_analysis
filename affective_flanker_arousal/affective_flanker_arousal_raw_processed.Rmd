...
threeway_interaction_analysis = outlier_detection(threeway_interaction_analysis, trial_sd_cut = 4,participant_sd_cut = 2.5, participant_id, is_congruent, is_prev_cong, n_min3_cong, n_min4_arousal)
