...
test = outlier_detection(unfiltered_test,trial_sd_cut = 2,participant_sd_cut = 9, participant_id, is_congruent, is_prev_cong)
...
threeway_interaction_analysis = outlier_detection(threeway_interaction_analysis, trial_sd_cut = 4,participant_sd_cut = 2.5, participant_id, is_congruent, n_min3_cong, n_min4_arousal)
...
# Exclude participants and trials based on criteria
...
```{r}
response_rt_analysis = global_exclusion(test)
...
write_tsv(cohen_effect_analysis, file.path(current_version, "data", "Processed", "flanker_arousal_cohen_effect_analysis.tsv"))

write_tsv(threeway_interaction_analysis, file.path(current_version, "data", "Processed", "flanker_arousal_threeway_interaction_analysis.tsv"))
